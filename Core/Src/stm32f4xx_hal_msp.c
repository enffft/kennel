...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB0     ------> ADC1_IN8
    */
    HAL_GPIO_DeInit(CS1_Accel_GPIO_Port, CS1_Accel_Pin);

    HAL_GPIO_DeInit(CS1_Gyro_GPIO_Port, CS1_Gyro_Pin);
...
void HAL_TIM_OnePulse_MspInit(TIM_HandleTypeDef* htim_onepulse)
{
  ...
  else if(htim_onepulse->Instance==TIM4)
  {
  ...
  else if(htim_onepulse->Instance==TIM5)
  {
